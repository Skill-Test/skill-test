    ...
    static async createWallet(userId, keyphrase, locale) {
        try {
            ...
            return {response:true, message:"success", data:{publicKey:wallet.publickey, privateKey: privateKey}}
                ...
                winston.error(`Error in createWallet: ${error.message}`, { error });
                return { response: false, message: "error when creating wallet.", data: null };
            }
    }
    ...
    static async addToken(rawData, userId) {
        try{
            ...
            return {response: true, message:"success", data:assets.split(",")}
                ...
                winston.error(`Error in addToken: ${error.message}`, { error });
                return { response: false, message: "error when adding token.", data: null };
        }
    ...
    static async getBalance(rawData, userId) {
        try {
            ...
            if (rawData.network === "polygon-mainnet") {
                ...
                winston.error(`Error in getBalance: ${error.message}`, { error });
                return { response: false, message: "error when getting balance.", data: null };
        }
    }
    ...
    static async getPrice(rawData, userId) {
         try {
            ...
            if (rawData.network === "polygon-mainnet") {
                ...
                winston.error(`Error in getPrice: ${error.message}`, { error });
                return { response: false, message: "error when getting price.", data: null };
        }
    }
    ...
    static async updateTopTokens() {
         try {
            ...
            if (tokenList.length === 0) {
                ...
                winston.error((`Error in updateTopTokens: ${error.message}`, { error });
                return { response: false, message: "error when updating TopTokens.", data: null };
        }
    }
    ...
    static async getTopTokens() {
        try {
            ...
            if (tokenList.length === 0) {
                ...
                winston.error(`Error in getTopTokens: ${error.message}`, { error });
                return { response: false, message: "error when getting TopTokens.", data: null };
        }
    }
    ...
    static async getAssets(rawData, userId) {
        try {
            ...
            if (rawData.network === "polygon-mainnet") {
                ...
                winston.error(`Error in getAssets: ${error.message}`, { error });
                return { response: false, message: "error when getting Assets.", data: null };
        }
    }
    ...
    static async sendToken(rawData, userId) {
        try {
            ...
            return {response:true, message:"Success", data:null}
                ...
                winston.error(`Error in sendToken: ${error.message}`, { error });
                return { response: false, message: "error when sending token.", data: null };
        }
    }
    ...
    static async getTransaction(rawData, userId) {
        try {
            ...
            return {response:true, message:"Success", data: transactionList}
                ...
                winston.error(`Error in getTransaction: ${error.message}`, { error });
                return { response: false, message: "error when getting Transaction.", data: null };
        }
    }
    ...
    static async receiveToken(rawData, userId) {
        try {
            ...
            if (rawData.network === "polygon-mainnet") {
                ...
                winston.error(`Error in reciveToken: ${error.message}`, { error });
                return { response: false, message: "error when reciving Token.", data: null };
        }
    }
    ...
    static async getSecret(rawData, userId) {
        try {
            ...
            return {response:true, message:"Success", data:data}
                ...
                winston.error(`Error in getSecret: ${error.message}`, { error });
                return { response: false, message: "error when getting Secret.", data: null };
        }
    }
    ...
    static async getPrivateKey(rawData) {
        try {
            ...
            return privateKey
                ...
                winston.error(`Error in getPrivatekey: ${error.message}`, { error });
                return { response: false, message: "error when getting PrivateKey.", data: null };
        }
    }
    ...
    static async getKeyPhrase(rawData, userId) {
        try {
            ...
            return keyPhrase
                ...
                winston.error(`Error in getKeyPhrase: ${error.message}`, { error });
                return { response: false, message: "error when getting KeyPhrase.", data: null };
        }
    }
    ...
    static async getWalletByEmail(email) {
        try {
            ...
            return {response:true, message:"Success", data:wallet.publickey};
                ...
                winston.error(`Error in WalletByEmail: ${error.message}`, { error });
                return { response: false, message: "error when getting wallet by email.", data: null };
        }
    }
    ...
    static async getCoinForTransaction(rawData, userId) {
        try {
            ...
            return {response:true, message:"Success", data:null}
                ...
                winston.error(`Error in getCoinForTransaction: ${error.message}`, { error });
                return { response: false, message: "error when getting coin.", data: null };
        }  
    }
}
